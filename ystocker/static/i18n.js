...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'share.nav_title':    { en: 'Email one of your reports to somebody',
                            zh: '把你的报告用邮件发送给他人' },
    'share.title':        { en: 'Share a report', zh: '分享报告' },
    'share.subtitle':     { en: 'They will get the full report by email, plus a link that works without signing in.',
                            zh: '对方将通过邮件收到完整报告，并附带一个无需登录即可打开的链接。' },
    ...
    'assets.signin_title':  { en: 'Sign in to track your assets',
                               zh: '登录以管理你的资产' },
    'assets.signin_body':   { en: 'Your positions are private to your account. Import a CSV from your broker, or add holdings by hand, and see look-through exposure to every underlying company.',
                               zh: '你的持仓仅对你的账户可见。可从券商导入 CSV，或手动添加持仓，然后查看穿透到每一家底层公司的真实敞口。' },
    ...
    'assets.ai_privacy':    { en: 'Only a portfolio summary is sent to Gemini. Email, account names, quantities and CSV text are omitted.',
                               zh: '仅向 Gemini 发送组合摘要；不会发送邮箱、账户名称、持仓数量或 CSV 原文。' },
    ...
    'assets.th_actions':    { en: '',                   zh: '' },
    'assets.empty':         { en: 'No positions yet — import a CSV or add one below.',
                               zh: '暂无持仓 — 请导入 CSV 或在下方添加。' },
    ...
    'assets.import_body':   { en: 'Upload a positions export from Fidelity, Schwab, Vanguard, Interactive Brokers, Robinhood, E*TRADE or Futu. Columns are detected automatically and shown for review before anything is saved.',
                               zh: '上传来自 Fidelity、嘉信、先锋、盈透、Robinhood、E*TRADE 或富途的持仓导出文件。系统会自动识别列名，并在保存前供你核对。' },
    'assets.import_pick':   { en: 'Choose CSV file',    zh: '选择 CSV 文件' },
