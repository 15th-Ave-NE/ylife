...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'mult.kpi_spy':       { en: 'SPY forward P/E', zh: 'SPY 预期市盈率' },
    'mult.kpi_qqq':       { en: 'QQQ forward P/E', zh: 'QQQ 预期市盈率' },
    'mult.kpi_spxpe':     { en: 'S&P 500 trailing P/E', zh: '标普500追踪市盈率' },
    'mult.kpi_pctl':      { en: 'P/E percentile since 1871', zh: '市盈率1871年以来百分位' },
    'mult.kpi_eps':       { en: 'S&P 500 trailing EPS (nominal)', zh: '标普500追踪��股收益（名义���' },
    ...
    'mult.sec_fwdhist':   { en: 'Forward P/E History — S&P 500 / SPY', zh: '预期市盈率历史 — 标普500 / SPY' },
    ...
    'mult.method_caveat': { en: 'Trailing and forward multiples are not comparable to each other — forward earnings are normally higher, so a forward P/E sits below the trailing one for the same market. The forward figure is an estimate over the index members whose fundamentals the app already tracks, cap-weighted; the constituent count is shown beneath the chart. It is computed from cached fundamentals rather than by querying every constituent, because bulk per-name requests get the whole app throttled by Yahoo.',
                            zh: '追踪与预期倍数彼此不可直接比较——预期盈利通常更高，因此同一市场的预期市盈率低于追踪市盈率。预期数值是对本应用已跟踪基本面的指数成分股按市值加权的估算，成分股数量显示在图表下方。该数值由缓存的基本面数据计算，而非逐一查询全部成分股，因为大批量的单只请求会导致整个应用被 Yahoo 限流。' },
