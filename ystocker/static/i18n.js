...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    // Sub-texts in markets.html still missing data-i18n
    'markets.skew_note':             { en: 'SKEW >140 = elevated tail risk demand. Historical avg ~130.',
                                       zh: 'SKEW>140 = 尾部风险需求上升。历史均值约130。' },
    ...
    'markets.skew_guide_layer1':     { en: 'SKEW >140–145 is notable; compare to its 1–3 year percentile range, not a fixed number.',
                                       zh: 'SKEW>140–145才值得关注；要比较过去1–3年的分位数区间，而不是死记某个绝对值。' },
