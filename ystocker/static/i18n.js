...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'mult.subtitle':      { en: 'S&P 500 trailing P/E back to 1871, and a cap-weighted forward P/E for SPY and QQQ',
                            zh: '标普500追踪市盈率（可追溯至1871年），以及 SPY 与 QQQ 的市值加权预期市盈率' },
    ...
    'mult.kpi_eps':       { en: 'S&P 500 trailing EPS (nominal)', zh: '标普500追踪每股收益（名义）' },
    ...
    'mult.fwdhist_scope': { en: 'This is the S&P 500 — the index SPY tracks. There is no equivalent for QQQ: nobody publishes Nasdaq-100 earnings history for free, so the Nasdaq-100 appears only in today\u2019s reading above.',
                            zh: '此为标普500指数——即 SPY 所跟踪的指数。QQQ 没有对应数据：纳斯达克100的历史盈利没有免费来源，因此纳斯达克100仅出现在上方的今日数值中。' },
    'mult.fwd_scope':     { en: "Consensus forward estimates for both ETFs, as of today. SPY's long history is the S&P 500 chart below; the Nasdaq-100 has no free earnings history, so QQQ builds up from the first snapshot only.",
                            zh: '两只 ETF 的一致预期数值（截至今日）。SPY 的长期历史见下方标普500图表；纳斯达克100没有免费的历史盈利数据，因此 QQQ 只能自首次快照起逐日累积。' },
    ...
    'mult.fwd_title':     { en: 'Forward P/E: SPY vs QQQ — consensus estimates, today',
                            zh: '预期市盈率：SPY vs QQQ — 一致预期，截至今日' },
    ...
    'mult.fwd_seeding':   { en: "Only today's reading has been recorded so far, so this shows the two side by side. It becomes a time series once a second daily snapshot lands.",
                            zh: '目前仅记录了今天的数值，因此先以并列方式对比两者。待第二个每日快照生成后，将自动转为时间序列图。' },
    ...
    'mult.spxeps_title':  { en: 'S&P 500 Trailing Earnings per Share (nominal)', zh: '标普500追踪每股收益（名义）' },
    ...
    'mult.series_spxeps': { en: 'S&P 500 trailing EPS (nominal)', zh: '标普500追踪每股收益（名义）' },
    ...
    'guide.s8_desc':        { en: "A team of AI analysts, researchers and risk managers debates one ticker and produces a full research report. A deep run takes ten minutes or more, so the page streams each agent's section as it lands rather than making you wait for the end.",
                              zh: '由 AI 分析师、研究员与风控经理组成的团队围绕一只标的展开辩论，并产出完整的研究报告。深度分析通常需要十分钟以上，因此页面会在每位智能体完成时即时推送其内容，无需等到全部结束。' },
    ...
    'fed.ism_title':                 { en: '🏭 ISM Manufacturing PMI',              zh: '🏭 ISM制造业PMI' },
    'fed.ism_desc':                  { en: 'Above 50 = expansion, below 50 = contraction. Leads earnings and S&P 500 by 3–6 months. Classic business cycle barometer.',
                                       zh: '高于50=扩张，低于50=收缩。领先企业盈利和标普5003–6个月。经典商业周期晴雨表。' },
    ...
    'fed.business_cycle_desc':       { en: 'ISM Manufacturing PMI (50 = expansion/contraction line) and Housing Starts (k units) — both lead the economy by 3–9 months.',
                                       zh: 'ISM制造业PMI（50=扩张/收缩分界线）和新房开工量（千套）——均领先经济3–9个月。' },
    ...
    'fed.gdp_ism_title':             { en: 'Real GDP Growth vs ISM PMI',            zh: '实际GDP增长 vs ISM PMI' },
    'fed.gdp_ism_desc':              { en: 'ISM PMI leads real GDP by 1–2 quarters. When PMI crosses below 50, GDP contraction typically follows.',
                                       zh: 'ISM PMI领先实际GDP 1–2个季度。PMI跌破50往往预示GDP收缩。' },
