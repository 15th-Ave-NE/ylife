...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'share.nav_title':    { en: 'Email or text one of your reports to somebody',
                            zh: '把你的报告用邮件或短信发送给他人' },
    'share.title':        { en: 'Share a report', zh: '分享报告' },
    'share.subtitle':     { en: 'Email it, or text the link — either way it opens without signing in.',
                            zh: '用邮件发送，或者把链接发短信给对方——无论哪种方式对方都无需登录即可打开。' },
