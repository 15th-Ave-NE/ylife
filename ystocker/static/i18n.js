...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'mult.kpi_pctl':      { en: 'Percentile since 1871', zh: '1871年以来百分位' },
    'mult.kpi_eps':       { en: 'S&P 500 trailing EPS', zh: '标普500追踪每股收益' },
    ...
    'mult.fwd_seeding':   { en: "Only one day recorded so far — the line appears once there are at least two snapshots. Today's values are in the tiles above.",
                            zh: '目前仅记录了一天的数据——至少有两个快照后才会显示折线。今日数值见上方指标卡。' },
    ...
    'mult.spxeps_title':  { en: 'S&P 500 Trailing Earnings per Share', zh: '标普500追踪每股收益' },
    ...
    'mult.series_spxeps': { en: 'S&P 500 trailing EPS', zh: '标普500追踪每股收益' },
