...
ROLES: list[dict[str, str]] = [
    ...
    {"key": "earnings",     "name": "Earnings Analyst",     "zh": "盈利预期修正分析师",
     "short": "Earnings", "icon": "📊", "color": "#7c3aed", "group": "analysts"},
    {"key": "quality",      "name": "Quality Analyst",      "zh": "经营质量分析师",
     "short": "Quality", "icon": "🛡️", "color": "#0d9488", "group": "analysts"},
    {"key": "valuation",    "name": "Valuation Analyst",    "zh": "估值分析师",
     "short": "Valuation", "icon": "💰", "color": "#ca8a04", "group": "analysts"},
